...
public class Cooking extends Skill {
    ...
    public List<Component> getHoverInfo() {
        ...
        info.add(Component.text("Trained by: Cooking and crafting food", NamedTextColor.AQUA));
        info.add(Component.text("Increases cooking mastery", NamedTextColor.DARK_AQUA));
        return info;
    }
}
